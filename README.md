...
Your Answer:
It gets rid of child elements. You create a class of "clearfix" and then use the following syntax.
.clearfix:after {
  content: "."
  visibility: hidden;
  display: block;
...
Your Answer:
Local variables defined in a function cannot be accessed from outside of the function because it was defined only in that particular scope.
...
Your Answer:
https://github.com/jnichols300/project_1.git
```
