...
Your Answer:
```Variables created in functions with var are only useable in that function, they are local variables. Variables created outside of functions are global variables. Variables created without var are global variables.
```
